# Greetings [![Build Status](https://travis-ci.org/aquariusmaster/Greetings.svg?branch=master)](https://travis-ci.org/aquariusmaster/Greetings)
...
Код решения должен быть опубликован на GitHub’е без упоминания названия фирмы. В README должен присутствовать статус сборки от Travis CI (https://docs.travis-ci.com/user/status-images/) или Circle CI (https://circleci.com/docs/status-badges).
